SELECT
    ...
    AVG(c.max_depth_of_commit_history - c.min_depth_of_commit_history) AS bic_avg_depth_diff,
    MAX(c.max_depth_of_commit_history - c.min_depth_of_commit_history) AS bic_max_depth_diff,
